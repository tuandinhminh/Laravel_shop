...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <form action="{{route('themslide')}}" method="POST" enctype="multipart/form-data" style="padding: 0 10px;">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" placeholder="link" name="link" value="{{isset($req)?$req->link:''}}">
                    </div>
                </div>
                <div class="form-group row">
