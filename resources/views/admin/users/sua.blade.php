...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <form action="{{route('suauser',$user->id)}}" method="POST" style="padding: 0 10px;">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" placeholder="name" name="full_name" value="{{isset($user)?$user->full_name:''}}">
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="number" class="form-control" name="phone" value="{{isset($user)?$user->phone:''}}">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <select class="form-group" name="level">
                            <option value="0" {{(isset($user) and $user->level == 0 )?'selected':''}}>Customer</option>
                            <option value="1" {{(isset($user) and $user->level == 1 )?'selected':''}}>Admin</option>
                        </select>
