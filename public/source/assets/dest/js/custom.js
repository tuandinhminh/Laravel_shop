					...
					tpj('.banner').revolution(
						{
							...
							stopAfterLoops:-1,						// Stop Timer if All slide has been played "x" times. IT will stop at THe slide which is defined via stopAtSlide:x, if set to -1 slide never stop automatic
...
if(is_touch_device()){
    ...
    // function to check is users is on touch device
